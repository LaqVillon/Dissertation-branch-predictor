...
def main():
    ...
    lst_fineName = ['.../I1-10k.csv', 'I2-10k.csv', 'S1-10k.csv', 'S2-10k.csv', 'M1-10k.csv', 'M2-10k.csv']
    numPreditores = len(lst_fineName)
    brancDataSetI1_np, numBlks = loadTest(lst_fineName)

    # Test I1 50%
    percent_otimo = 0.5
    l_test_i1 = randTest(numBlks, IDPI1, numPreditores, percent_otimo) 
    print(l_test_i1)
    ...
    # Uso para teste do vetor de preditores random
    # cada randTest mostra a execução ao 50% de uso do melhor preditor
    # print(randTest(numBlks, IDPI1, numPreditores, percent_otimo))
    # print(randTest(numBlks, IDPI2, numPreditores, percent_otimo))
    # print(randTest(numBlks, IDPS1, numPreditores, percent_otimo))
    # print(randTest(numBlks, IDPS2, numPreditores, percent_otimo))
    # print(randTest(numBlks, IDPM1, numPreditores, percent_otimo))
    # print(randTest(numBlks, IDPM2, numPreditores, percent_otimo))
#END - main
